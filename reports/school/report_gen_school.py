...
latex_lines.append(r"{\Huge\bfseries\color{primaryblue} OULAD Student\\[0.3em] At-Risk Detection Report\par}")
...
latex_lines.append(r"{\small OULAD Learning Analytics - Automated Report Generation System\par}")
