...
MODEL_PATH = PROJECT_ROOT / "models" / "training" / "local_outlier_factor" / "models" / "local_outlier_factor_cyber.pkl"
INPUT_FILE = PROJECT_ROOT / "datasets" / "data" / "split" / "cyber_inference.csv"
OUTPUT_FILE = BASE_DIR / "predictions" /"predictions_cyber_local_outlier_factor.json"
