...
MODEL_PATH = PROJECT_ROOT / "models" / "training" / "local_outlier_factor" / "models" / "local_outlier_factor_school.pkl"
INPUT_FILE = PROJECT_ROOT / "datasets" / "data" / "split" / "school_inference.csv"
OUTPUT_FILE = BASE_DIR / "predictions" /"predictions_school_local_outlier_factor.json"
