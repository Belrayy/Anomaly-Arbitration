...
MODEL_PATH = PROJECT_ROOT / "models" / "training" / "isolation_forest" / "models" / "isolation_forest_school.pkl"
INPUT_FILE = PROJECT_ROOT / "datasets" / "data" / "split" / "school_inference.csv"
OUTPUT_FILE = BASE_DIR / "predictions" /"predictions_school_isolation_forest.json"
