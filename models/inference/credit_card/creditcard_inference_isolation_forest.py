...
MODEL_PATH = PROJECT_ROOT / "models" / "training" / "isolation_forest" / "models" / "isolation_forest_creditcard.pkl"
INPUT_FILE = PROJECT_ROOT / "datasets" / "data" / "split" / "creditcard_inference.csv"
OUTPUT_FILE = BASE_DIR / "predictions" /"predictions_creditcard.json"
