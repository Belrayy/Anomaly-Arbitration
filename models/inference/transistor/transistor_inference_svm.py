...
MODEL_PATH = PROJECT_ROOT / "models" / "training" / "svm" / "models" / "sgd_one_class_svm_transistor.pkl"
INPUT_FILE = PROJECT_ROOT / "datasets" / "data" / "split" / "transistor_inference.csv"
OUTPUT_FILE = BASE_DIR / "predictions" /"predictions_transistor_one_class_svm.json"
