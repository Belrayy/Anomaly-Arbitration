...
MODEL_PATH = PROJECT_ROOT / "models" / "training" / "isolation_forest" / "models" / "isolation_forest_transistor.pkl"
INPUT_FILE = PROJECT_ROOT / "datasets" / "data" / "split" / "transistor_inference.csv"
OUTPUT_FILE = BASE_DIR / "predictions" /"predictions_transistor_isolation_forest.json"
